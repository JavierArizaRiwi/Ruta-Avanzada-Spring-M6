...
*(Opcional para cobertura: agrega el plugin JaCoCo como en Semana 6 Día 1.)*
...
5. (Posterior) Exponlo por **API Gateway** como en Semana 6 Día 2; agrega **contract tests** por gateway en Semana 6 Día 3.
